...
import 'package:farmsponsor_test/utils/indication_painter.dart';
        ...
        children: <Widget>[
          Stack(
            ...
            children: <Widget>[
              ...
              Padding(
                  padding: EdgeInsets.only(top: 170.0,right: 25.0),
                  child: new Row(
              ...
              Container(
                ...
                onPressed: ()  => showInSnackBar("Signin button pressed"),
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                          ...
                          child: new Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                new Text("By tapping create new account, you agree \nto the terms & condition",textAlign: TextAlign.center,)
                              ]
                          )
                      ),
                    ],
